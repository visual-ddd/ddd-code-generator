...
public class ChartUpdateEvent extends BaseDomainEvent {
    ...
    public ChartUpdateEvent(ChartUpdateCmd cmd
    ) {
    ...
    public String eventCode() {
        return "${event.wd-generator-web.codegen.domainchart.chartUpdate}";
    }
