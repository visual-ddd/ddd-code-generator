...
@DisplayName("代码生成服务-单体架构-MVP版本-静态测试")
public class CodeGenerateServiceSingleMVPTest {

    public static final String RESULT_VERIFY_PATH = "src/test/resources/resultVerify-single-mvp/";
    ...
    private static void executeGenService(String testJson, String message, Boolean isGenerateProjectFrame) {
        ...
        TemplateContext templateContext = new TemplateContext(CodeGenerateServiceSingleMVPTest.RESULT_VERIFY_PATH);
        templateContext.setIsGenerateProjectFrame(isGenerateProjectFrame);
        templateContext.setProjectTemplateType(ProjectTemplateType.COLA_SINGLE_MVP);
    ...
    private static void compareGenResult() {
        ...
        Process process = runtime.exec("git diff HEAD --stat -- " + CodeGenerateServiceSingleMVPTest.RESULT_VERIFY_PATH);
        process.waitFor();
