...
public class CodeGenerateUpdateServiceTest {

    public static final String RESULT_VERIFY_PATH = "src/test/resources/resultUpdateVerify/";
    ...
    private static void executeGenService(String testJson, String message, Boolean isGenerateProjectFrame) {
        ...
        TemplateContext templateContext = new TemplateContext(CodeGenerateUpdateServiceTest.RESULT_VERIFY_PATH);
        ...
        templateContext.setOperationTypeEnum(GenerateOperationTypeEnum.UPDATE_CODE);
    ...
    private static void compareGenResult() {
        ...
        Process process = runtime.exec("git diff HEAD --stat -- " + CodeGenerateUpdateServiceTest.RESULT_VERIFY_PATH);
        process.waitFor();
