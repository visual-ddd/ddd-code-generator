...
public class ApplicationCreateCmdEvent extends BaseDomainEvent {
    ...
    public ApplicationCreateCmdEvent() {}

    public ApplicationCreateCmdEvent(ApplicationCreateCmd cmd
        , Long id
    ) {
        this.id = id;
