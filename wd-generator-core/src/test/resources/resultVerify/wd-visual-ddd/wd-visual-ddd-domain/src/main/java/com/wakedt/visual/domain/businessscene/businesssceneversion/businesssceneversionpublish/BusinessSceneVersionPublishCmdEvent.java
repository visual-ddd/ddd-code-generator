...
public class BusinessSceneVersionPublishCmdEvent extends BaseDomainEvent {
    
    /** 业务场景版本ID */
    private Long id;
    
    public BusinessSceneVersionPublishCmdEvent() {}

    public BusinessSceneVersionPublishCmdEvent(BusinessSceneVersionPublishCmd cmd
    ) {
        this.id = cmd.getId();
    }
