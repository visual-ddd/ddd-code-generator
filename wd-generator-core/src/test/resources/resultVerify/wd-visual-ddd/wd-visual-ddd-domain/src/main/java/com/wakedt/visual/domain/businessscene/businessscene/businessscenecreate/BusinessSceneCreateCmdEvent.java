...
public class BusinessSceneCreateCmdEvent extends BaseDomainEvent {
    ...
    public BusinessSceneCreateCmdEvent() {}

    public BusinessSceneCreateCmdEvent(BusinessSceneCreateCmd cmd
        , Long id
    ) {
        this.id = id;
