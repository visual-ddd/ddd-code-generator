...
public class BusinessSceneVersionCreateCmdEvent extends BaseDomainEvent {
    ...
    public BusinessSceneVersionCreateCmdEvent() {}

    public BusinessSceneVersionCreateCmdEvent(BusinessSceneVersionCreateCmd cmd
        , Long id
    ) {
        this.id = id;
