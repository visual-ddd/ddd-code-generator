...
public class OrganizationManagerUnbindCmdEvent extends BaseDomainEvent {
    
    /** 组织 ID */
    private Long id;
    
    public OrganizationManagerUnbindCmdEvent() {}

    public OrganizationManagerUnbindCmdEvent(OrganizationManagerUnbindCmd cmd
    ) {
        this.id = cmd.getId();
    }
