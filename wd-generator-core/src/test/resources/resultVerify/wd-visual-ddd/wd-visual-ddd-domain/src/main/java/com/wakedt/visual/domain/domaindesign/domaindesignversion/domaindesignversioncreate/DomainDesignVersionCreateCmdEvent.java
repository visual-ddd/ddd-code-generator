...
public class DomainDesignVersionCreateCmdEvent extends BaseDomainEvent {
    ...
    public DomainDesignVersionCreateCmdEvent() {}

    public DomainDesignVersionCreateCmdEvent(DomainDesignVersionCreateCmd cmd
        , Long id
    ) {
        this.id = id;
