...
public class DomainDesignVersionPublishCmdEvent extends BaseDomainEvent {
    
    /** 业务域场景ID */
    private Long id;
    
    public DomainDesignVersionPublishCmdEvent() {}

    public DomainDesignVersionPublishCmdEvent(DomainDesignVersionPublishCmd cmd
    ) {
        this.id = cmd.getId();
    }
