...
public class UniversalLanguageCreateCmdEvent extends BaseDomainEvent {
    ...
    public UniversalLanguageCreateCmdEvent() {}

    public UniversalLanguageCreateCmdEvent(UniversalLanguageCreateCmd cmd
        , Long id
    ) {
        this.id = id;
