...
public class UniversalLanguageModifyCmdEvent extends BaseDomainEvent {
    ...
    public UniversalLanguageModifyCmdEvent() {}

    public UniversalLanguageModifyCmdEvent(UniversalLanguageModifyCmd cmd
    ) {
        this.id = cmd.getId();
    ...
    public String eventCode() {
        return "${event.com.wakedt.visual.domain.universallanguage.universallanguage.modify}";
    }
}
