...
public class DomainDesignVersionForkCmdEvent extends BaseDomainEvent {
    ...
    public DomainDesignVersionForkCmdEvent() {}

    public DomainDesignVersionForkCmdEvent(DomainDesignVersionForkCmd cmd
    ) {
