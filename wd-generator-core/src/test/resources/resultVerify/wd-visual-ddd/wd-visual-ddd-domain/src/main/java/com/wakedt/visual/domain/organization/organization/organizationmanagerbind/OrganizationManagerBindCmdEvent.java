...
public class OrganizationManagerBindCmdEvent extends BaseDomainEvent {
    ...
    public OrganizationManagerBindCmdEvent() {}

    public OrganizationManagerBindCmdEvent(OrganizationManagerBindCmd cmd
    ) {
        this.id = cmd.getId();
