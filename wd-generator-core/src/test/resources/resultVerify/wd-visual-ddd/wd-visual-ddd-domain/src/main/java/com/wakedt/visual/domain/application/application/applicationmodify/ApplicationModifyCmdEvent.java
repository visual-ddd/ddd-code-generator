...
public class ApplicationModifyCmdEvent extends BaseDomainEvent {
    ...
    public ApplicationModifyCmdEvent() {}

    public ApplicationModifyCmdEvent(ApplicationModifyCmd cmd
    ) {
        this.id = cmd.getId();
