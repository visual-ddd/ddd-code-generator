...
public class AccountVerificationCreateCmdEvent extends BaseDomainEvent {
    ...
    public AccountVerificationCreateCmdEvent() {}

    public AccountVerificationCreateCmdEvent(AccountVerificationCreateCmd cmd
    ) {
