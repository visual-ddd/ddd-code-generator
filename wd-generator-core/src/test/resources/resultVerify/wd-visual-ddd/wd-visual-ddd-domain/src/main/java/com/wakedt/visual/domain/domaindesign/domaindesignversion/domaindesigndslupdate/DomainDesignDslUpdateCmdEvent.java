...
public class DomainDesignDslUpdateCmdEvent extends BaseDomainEvent {
    ...
    public DomainDesignDslUpdateCmdEvent() {}

    public DomainDesignDslUpdateCmdEvent(DomainDesignDslUpdateCmd cmd
    ) {
        this.id = cmd.getId();
