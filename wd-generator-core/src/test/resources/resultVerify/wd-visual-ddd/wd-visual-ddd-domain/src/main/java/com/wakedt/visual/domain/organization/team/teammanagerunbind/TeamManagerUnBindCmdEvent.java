...
public class TeamManagerUnBindCmdEvent extends BaseDomainEvent {
    
    /** 主键 */
    private Long id;
    
    public TeamManagerUnBindCmdEvent() {}

    public TeamManagerUnBindCmdEvent(TeamManagerUnBindCmd cmd
    ) {
        this.id = cmd.getId();
    }
