...
public class TeamMemberRoleUnBindCmdEvent extends BaseDomainEvent {
    ...
    public TeamMemberRoleUnBindCmdEvent() {}

    public TeamMemberRoleUnBindCmdEvent(TeamMemberRoleUnBindCmd cmd
    ) {
        this.id = cmd.getId();
