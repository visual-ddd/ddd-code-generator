...
public class BusinessSceneVersionDSLUpdateCmdEvent extends BaseDomainEvent {
    ...
    public BusinessSceneVersionDSLUpdateCmdEvent() {}

    public BusinessSceneVersionDSLUpdateCmdEvent(BusinessSceneVersionDSLUpdateCmd cmd
    ) {
        this.id = cmd.getId();
