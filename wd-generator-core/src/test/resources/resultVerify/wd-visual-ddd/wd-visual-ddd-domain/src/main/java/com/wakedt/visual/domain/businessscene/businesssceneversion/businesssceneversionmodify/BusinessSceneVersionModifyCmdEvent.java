...
public class BusinessSceneVersionModifyCmdEvent extends BaseDomainEvent {
    ...
    public BusinessSceneVersionModifyCmdEvent() {}

    public BusinessSceneVersionModifyCmdEvent(BusinessSceneVersionModifyCmd cmd
    ) {
        this.id = cmd.getId();
