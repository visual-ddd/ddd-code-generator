...
public class ApplicationVersionForkCmdEvent extends BaseDomainEvent {
    ...
    public ApplicationVersionForkCmdEvent() {}

    public ApplicationVersionForkCmdEvent(ApplicationVersionForkCmd cmd
    ) {
