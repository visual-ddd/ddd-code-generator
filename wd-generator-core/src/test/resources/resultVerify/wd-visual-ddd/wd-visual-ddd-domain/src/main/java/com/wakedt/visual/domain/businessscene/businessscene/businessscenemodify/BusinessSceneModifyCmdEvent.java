...
public class BusinessSceneModifyCmdEvent extends BaseDomainEvent {
    ...
    public BusinessSceneModifyCmdEvent() {}

    public BusinessSceneModifyCmdEvent(BusinessSceneModifyCmd cmd
    ) {
        this.id = cmd.getId();
