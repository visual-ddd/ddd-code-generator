...
public class DomainDesignCreateCmdEvent extends BaseDomainEvent {
    ...
    public DomainDesignCreateCmdEvent() {}

    public DomainDesignCreateCmdEvent(DomainDesignCreateCmd cmd
        , Long id
    ) {
        this.id = id;
