...
public class PageQueryExeGenerator extends AbstractGenerator {
    ...
    public String[] getElementTypeUrl() {
        return GenerateElementTypeEnum.PAGE_QUERY_EXE.getTemplateUrls();
    }
    ...
    public String parseOutputPath(String templateUrl, VelocityContext context, String targetPath) {
        return super.parseOutputPath(templateUrl, context, targetPath)
            ...
            .replace(ModelUrlConstant.PAGE_QUERY_EXE_CLASS, umlClass.getClassName());
    }
}
