...
public class CmdEventGenerator extends AbstractGenerator {
    ...
    public void putVelocityContext(VelocityContext context) {
        context.put(VelocityLabel.CMD_EVENT_CLASS_NAME, umlClass.getClassName());
        context.put(VelocityLabel.CMD_EVENT_CLASS_PACKAGE, umlClass.getClassPackage());
        context.put(VelocityLabel.CMD_EVENT_CLASS_DESCRIPTION, umlClass.getClassDesc());
        context.put(VelocityLabel.CMD_EVENT_CLASS_FIELDS, umlClass.getFieldList());
        context.put(VelocityLabel.CMD_EVENT_CLASS_METHODS, umlClass.getMethodList());
    }
    ...
    public String parseOutputPath(String templateUrl, VelocityContext context, String targetPath) {
        return super.parseOutputPath(templateUrl, context, targetPath)
                ...
                .replace(ModelUrlConstant.ACTION, ((String) context.get(VelocityLabel.CMD_EVENT_CLASS_PACKAGE)))
