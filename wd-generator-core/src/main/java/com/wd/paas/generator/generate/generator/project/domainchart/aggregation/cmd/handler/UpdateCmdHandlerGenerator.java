...
public class UpdateCmdHandlerGenerator extends CmdHandlerGenerator {

    @Override
    public GenerateElementTypeEnum getElementTypeUrl() {
        return GenerateElementTypeEnum.UPDATE_COMMAND_HANDLER;
    }
    ...
    public String parseOutputPath(String templateUrl, VelocityContext context, String targetPath) {
        return super.parseOutputPath(templateUrl, context, targetPath)
            ...
            .replace(ModelUrlConstant.UPDATE_COMMAND_HANDLER_CLASS, ((String) context.get(VelocityLabel.CMD_CLASS_NAME)));
    }
}
