...
//@Slf4j
//
//public class CodeGenerateServiceImpl {
//
//    public void generateCode(DomainChartGenerateDto domainChartGenerateDto, ZipOutputStream zipOutputStream) {
////        DomainChartCodeGenerator domainChartCodeGenerator = DomainChartCodeGenerator.getInstance();
////        domainChartCodeGenerator.run(transformProjectChart(domainChartGenerateDto), zipOutputStream);
//    }
//
//    /**
