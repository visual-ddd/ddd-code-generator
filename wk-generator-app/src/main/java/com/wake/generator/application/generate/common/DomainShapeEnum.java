...
public enum DomainShapeEnum {
     ...
     * 项目
     */
    PROJECT("Project", new String[]{"cola/{projectName}/pom.xml.vm",
    ...
    AGGREGATION("Aggregation", new String[]{
        ...
        // controller
        "cola/{projectName}/{projectName}-adapter/src/main/java/{group}/adapter/{field}/{aggregation}/AggregationController.java.vm",
        // repository
