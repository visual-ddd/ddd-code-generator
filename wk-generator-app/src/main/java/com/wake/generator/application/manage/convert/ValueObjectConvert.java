 ...
 */
@Mapper
public interface ValueObjectConvert extends BaseConvert<ValueObjectDto, ValueObjectDo> {

    ValueObjectConvert MAPPER = Mappers.getMapper(ValueObjectConvert.class);
